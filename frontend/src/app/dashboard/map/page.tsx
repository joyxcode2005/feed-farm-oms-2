        ...
        <div className="flex-1 overflow-y-auto p-4 space-y-3">
          {loading ? (
            ...
            <p className="text-sm text-zinc-400 text-center">
              No customers found in this district.
            </p>
          ) : filteredCustomers.length === 0 ? (
            <p className="text-sm text-zinc-400 text-center">
              Select a district to view customer list.
            </p>
          ) : (
            filteredCustomers.map((c) => (
              ...
              >
                ...
                {(!c.latitude || !c.longitude) && (
                  <div className="mt-1 text-[9px] text-red-400 text-right italic">
                    No Map Location
                  </div>
                )}
              </div>
      ...
      <div className="flex-1 bg-zinc-100 relative">
        ...
        >
          ...
          <TileLayer
            ...
            url="https://mt1.google.com/vt/lyrs=s,h&x={x}&y={y}&z={z}" // 'm' is for standard roadmap
          ...
          {geoJsonData && (
            <GeoJSON
              ...
              style={(feature) => ({
                ...
                color: "white",
                fillOpacity:
                  feature?.properties.district === selectedDistrict ? 0.4 : 0.1,
              })}
                ...
                <Popup>
                  <div className="min-w-[150px]">
                    ...
                    <div className="grid grid-cols-2 gap-x-4 gap-y-1 text-xs">
                      ...
                      <span className="font-bold text-zinc-700 text-right">
                        {c.totalOrders}
                      </span>
                    </div>
                  </div>
