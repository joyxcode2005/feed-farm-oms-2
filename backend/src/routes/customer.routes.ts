...
router.put("/:id", async (req: Request, res: Response) => {
  try {
    ...
    try {
      ...
      if (err.code === "P2002") return res.status(409).json({ success: false, message: "Customer with this phone already exists" });
...
router.get("/:id/orders", async (req: Request, res: Response) => {
  try {
    ...
    return res.status(200).json({ success: true, message: "Customer orders fetched successfully", data: orders });
  } catch (error) {
...
router.get("/:id/ledger", async (req: Request, res: Response) => {
  try {
    ...
    return res.status(200).json({ success: true, message: "Customer ledger fetched successfully", data: ledger });
  } catch (error) {
...
router.get("/:id/snapshots", async (req: Request, res: Response) => {
  try {
    ...
    return res.status(200).json({ success: true, message: "Customer snapshots fetched successfully", data: snapshots });
  } catch (error) {
